        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    system = "undetermined"
        return {"version":"1.0","release":"Alpha","system":system,"machine":platform.machine()}
    def docs(sub=""):
        try:
            ...
            pass
    def shell():
        print(f"Red Panda {utils.info()['version']} ({utils.info()['machine']}) on a {utils.info()['system']} system")
